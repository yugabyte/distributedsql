      ...
      <Layout>
        <Helmet
          ...
          meta={[
            ...
            { name: 'og:image', content: 'https://distributedsql.org/dss-summit-day-london.png' },
            { name: 'og:image:secure_url', content: 'https://distributedsql.org/dss-summit-day-london.png' },
            { name: 'twitter:card', content: 'summary_large_image' },
            { name: 'twitter:description', content: 'Join us on Distributed SQL Summit Day - London.' },
            { name: 'twitter:image', content: 'https://distributedsql.org/dss-summit-day-london.png' },
            { name: 'twitter:image:secure_url', content: 'https://distributedsql.org/dss-summit-day-london.png' },
