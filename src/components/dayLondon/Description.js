...
const Description = () => (
  <section id="conf-description" className="day-london-description">
    <div className="inner">
      <p>
      ...
      <p>
        <b>It’s time to ensure your database is also cloud-native-ready.</b>
      </p>
      <p>
      ...
      <div className="registernew-and-agenda">
        <h4>
          <a href="https://www.eventbrite.com/e/distributed-sql-day-london-tickets-260672597757" title="Register now to join us" target="_blank" rel="noopener">
