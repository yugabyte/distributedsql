...
const ContactBanner = ({ title, description, btnText, btnLink }) => (
  <StaticQuery query={graphql`
     query {
      desktopFooterImage: file(relativePath: { eq: "banner/dss-asia-footer-banner.png" }) {
        childImageSharp {
      ...
      mobileFooterImage: file(relativePath: { eq: "banner/dss-asia-footer-vertical-banner.png" }) {
        childImageSharp {
