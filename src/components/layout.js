      ...
      <div className={`body ${this.state.isMenuVisible ? 'is-menu-visible' : ''}`}>
        <Helmet
          ...
          meta={[
            ...
            { name: 'twitter:image', content: 'https://distributedsql.org/OGImage.png' },
            { name: 'twitter:image', content: 'https://distributedsql.org/OGImage.png' },
            { name: 'og:image:secure_url', content: 'https://distributedsql.org/OGImage.png' },
            { name: 'twitter:image:secure_url', content: 'https://distributedsql.org/OGImage.png' },
