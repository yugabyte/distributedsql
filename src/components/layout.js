            ...
            <div className={`body ${this.state.isMenuVisible ? 'is-menu-visible' : ''}`}>
                <Helmet
                    ...
                    meta={[
                        ...
                        { name: 'image', content: 'https://distributedsql.org/OG_Card.png' },
                        { name: 'og:url', content: 'https://distributedsql.org' },
                        { name: 'og:title', content: 'Distributed SQL Summit' },
                        { name: 'og:image', content: 'https://distributedsql.org/OG_Card.png' },
                        { name: 'twitter:image', content: 'https://distributedsql.org/OG_Card.png' },
